...
from brownie import (
    ...
    SettV4,
    Controller,
    RewardsRecoveryStrategy_governance,
)
...
def test_migrate_staking_optimizer(
    ...
    # Deploy new logic
    new_logic = RewardsRecoveryStrategy_governance.deploy({"from": deployer})
    ...
    gov_cvx_before = cvx.balanceOf(governance_multi)
    gov_cvxCrv_before = cvxCrv.balanceOf(governance_multi)
    gov_crv_before = crv.balanceOf(governance_multi)
    ...
    gov_cvx_after = cvx.balanceOf(governance_multi)
    gov_cvxCrv_after = cvxCrv.balanceOf(governance_multi)
    gov_crv_after = crv.balanceOf(governance_multi)
    gov_want_after = want.balanceOf(governance_multi)


    console.print("\nPost Harvest Balances Diff\n")

    console.print("\nStrat cvx:", strat_cvx_after-strat_cvx_before)
    ...
    console.print("\nGovernance cvx:", gov_cvx_after-gov_cvx_before)
    console.print("Governance cvxCrv:", gov_cvxCrv_after-gov_cvxCrv_before)
    console.print("Governance crv:", gov_crv_after-gov_crv_before)
