...
def test_migrate_staking_optimizer(
    ...
    gov_bcvx_before = bCvx.balanceOf(trops_multi)
    gov_bcvxCrv_before = bcvxCrv.balanceOf(trops_multi)
    gov_bveCVX_before = bveCVX.balanceOf(trops_multi)
    gov_want_before = want.balanceOf(trops_multi)
    ...
    gov_bcvx_after = bCvx.balanceOf(trops_multi)
    gov_bcvxCrv_after = bcvxCrv.balanceOf(trops_multi)
    gov_bveCVX_after = bveCVX.balanceOf(trops_multi)
    gov_want_after = want.balanceOf(trops_multi)
